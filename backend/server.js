...
// Datos base de estaciones para la API de congestión
...
// API de congestión en tiempo real
app.get('/api/congestion', (req, res) => {
    const date = new Date();
    const utc = date.getTime() + (date.getTimezoneOffset() * 60000);
    const coTime = new Date(utc + (3600000 * -5)); // Hora de Colombia (UTC-5)
    const hour = coTime.getHours();
    
    // Horas pico en Medellín: 6:00 - 8:30 y 17:00 - 19:30
