...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2026 a las 17:42:14
...
--
-- Estructura de tabla para la tabla `lineasayuda`
--
...
--
-- Volcado de datos para la tabla `lineasayuda`
--
...
--
-- Estructura de tabla para la tabla `mensajesmotivacionales`
--
...
--
-- Volcado de datos para la tabla `mensajesmotivacionales`
--
...
--
-- Estructura de tabla para la tabla `metrocoins`
--
...
--
-- Volcado de datos para la tabla `metrocoins`
--
...
--
-- Indices de la tabla `lineasayuda`
--
ALTER TABLE `lineasayuda`
  ADD PRIMARY KEY (`id_linea`);

--
-- Indices de la tabla `mensajesmotivacionales`
--
ALTER TABLE `mensajesmotivacionales`
  ADD PRIMARY KEY (`id_mensaje`);

--
-- Indices de la tabla `metrocoins`
--
